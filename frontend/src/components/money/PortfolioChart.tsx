    ...
    <div className="card">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between">
          ...
          <div className="inline-flex flex-wrap gap-1 rounded-xl bg-slate-100 p-1 xl:justify-end">
        ...
        {!hasValues ? (
          <div
            className="flex items-center justify-center rounded-2xl border border-dashed border-slate-200 bg-slate-50/60 text-sm text-slate-400"
          ...
          <ResponsiveContainer width="100%" height={chartHeight}>
            <ComposedChart data={points} margin={{ top: 8, right: 8, left: 4, bottom: 0 }}>
              ...
              />
              <Tooltip
                content={<ChartTooltip title={tooltipTitle ?? title} />}
